...
<head>
    ...
    <title>Coverage for /home/rami/.local/lib/python3.8/site-packages/py/_path/__init__.py: 100%</title>
...
<div id="header">
    <div class="content">
        <h1>Coverage for <b>/home/rami/.local/lib/python3.8/site-packages/py/_path/__init__.py</b> :
...
<div id="source">
    <p id="t1" class="pln"><span class="n"><a href="#t1">1</a></span><span class="t"><span class="str">""" unified file system api """</span>&nbsp;</span><span class="r"></span></p>
</div>
<div id="footer">
    <div class="content">
        <p>
